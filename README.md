...
### Диаграммы C4 Model
> Контекст, контейнеры, компоненты: TODO  
> картинки добавить как  `docs/1context.jpg`, `docs/containers.jpg`, `docs/components.jpg`.
...
TODO: описать почему такая схема выдержит нефунĸциональные требования

TODO: вставить картинку ERD схемы
